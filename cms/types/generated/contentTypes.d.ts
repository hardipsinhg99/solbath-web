...
export interface ApiCatalogCatalog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vertical: Schema.Attribute.Relation<'manyToMany', 'api::vertical.vertical'>;
  };
}
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vertical: Schema.Attribute.Relation<'manyToOne', 'api::vertical.vertical'>;
  };
}
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: "Leads submitted through the site's Contact form.";
...
export interface ApiInspirationPostInspirationPost
  ...
  info: {
    description: '';
    displayName: 'Inspiration Post';
    pluralName: 'inspiration-posts';
    singularName: 'inspiration-post';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::inspiration-post.inspiration-post'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ...
    room: Schema.Attribute.Enumeration<
      ['Bathroom', 'Kitchen', 'Guide', 'Outdoor']
    >;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    finishes: Schema.Attribute.Component<'shared.value-item', true>;
...
export interface ApiQuoteSubmissionQuoteSubmission
  ...
  info: {
    description: "Leads submitted through the site's Request a Quote form.";
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    initialProduct: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    persona: Schema.Attribute.Enumeration<['homeowner', 'architect', 'dealer']>;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    requirement: Schema.Attribute.Text;
    selection: Schema.Attribute.JSON;
    status: Schema.Attribute.Enumeration<['new', 'contacted', 'won', 'lost']> &
      Schema.Attribute.DefaultTo<'new'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
