...
export interface MegaMenuVerticalItem {
  href: string;
  vertical: Vertical;
  name: string;
  tagline: string;
  ...
  popular: MegaMenuProduct[];
}

interface ProductsMegaMenuProps {
  verticals: MegaMenuVerticalItem[];
  triggerClassName: string;
}

const EASE = "power3.out";

export function ProductsMegaMenu({ verticals, triggerClassName }: ProductsMegaMenuProps) {
