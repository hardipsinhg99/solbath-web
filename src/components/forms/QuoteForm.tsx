...
export function QuoteForm({
  ...
  return (
    <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
      <form action={formAction} className="space-y-5 rounded-none border border-border p-8">
        <input type="hidden" name="persona" value={persona} />
        <input type="hidden" name="initialProduct" value={initialProduct ?? ""} />
        <input type="hidden" name="selection" value={JSON.stringify(items)} />
