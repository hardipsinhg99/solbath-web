...
export const products: Product[] = [
  ...
  // ---------- Kitchen Faucets & Sinks ----------
  {
    ...
    description:
      "The Chef Pull-Out Kitchen Mixer pairs a high-arc silhouette with a flexible pull-out spray head, making rinsing cookware, produce and deep sinks easier without visual clutter.",
    finishes: ["Chrome", "Brushed Steel", "Matte Black"],
    specs: [
      { label: "Body Material", value: "Solid Brass" },
      { label: "Spray Modes", value: "Stream / Rinse" },
  ...
  },
  {
    ...
    description:
      "A deep undermount sink formed from heavy-gauge stainless steel with sound-dampening pads and a clean radius for easy wipe-downs.",
    finishes: ["Brushed Steel", "Gunmetal"],
    sizes: ["24in", "30in", "32in"],
    specs: [
      { label: "Material", value: "SS 304 Stainless Steel" },
      { label: "Installation", value: "Undermount" },
      { label: "Bowl Depth", value: "230mm" },
      { label: "Warranty", value: "10 Years" },
    ],
    tags: ["New"],
    isNew: true,
  ...
  },
  {
    ...
    description:
      "A workstation sink set with sliding accessories, including a chopping board, colander and roll-up rack, designed to extend usable counter space.",
    finishes: ["Brushed Steel", "Matte Black"],
    sizes: ["30in", "36in"],
    specs: [
      { label: "Accessories", value: "Board / Colander / Roll-Up Rack" },
      { label: "Material", value: "SS 304 Stainless Steel" },
      { label: "Mounting", value: "Top Mount / Undermount" },
    ],
    tags: [],
    tone: "kitchen",
  },

  // ---------- Kitchen Surfaces & Backsplashes ----------
  {
    ...
    description:
      "A large-format porcelain slab with deep Marquina-inspired veining, engineered for kitchen countertops, waterfall islands and splash zones.",
    finishes: ["Polished", "Honed"],
    sizes: ["1200x2400", "1600x3200"],
    specs: [
      { label: "Material", value: "Full-Body Porcelain" },
      { label: "Thickness", value: "12mm" },
      { label: "Application", value: "Countertop / Island / Wall" },
  ...
  },
  {
    ...
    description:
      "A bevelled glossy wall tile that reflects light beautifully above countertops, suited to straight-stack, brick and herringbone layouts.",
    finishes: ["Glossy"],
    sizes: ["75x300", "100x300"],
    specs: [
      { label: "Material", value: "Ceramic" },
      { label: "Application", value: "Backsplash / Wall" },
      { label: "Water Absorption", value: ">10% (wall use only)" },
    ],
    tags: [],
    tone: "kitchen",
  },
  {
    ...
    description:
      "A matte stone-look wall tile with soft tonal movement, designed to add warmth behind cooktops and counters without overpowering cabinetry.",
    finishes: ["Matte", "Textured"],
    sizes: ["300x600", "600x600"],
    specs: [
      { label: "Material", value: "Ceramic" },
      { label: "Finish", value: "Matte, Textured" },
      { label: "Application", value: "Backsplash / Feature Wall" },
    ],
    tags: ["New"],
    isNew: true,
    tone: "kitchen",
  ...
  // ---------- Kitchen Storage & Cabinet Hardware ----------
  {
    ...
    description:
      "A full-extension drawer box system with soft-close runners, high side stability and load support for cutlery, cookware and pantry storage.",
    finishes: ["Graphite", "Stainless Steel"],
    sizes: ["350mm", "450mm", "500mm"],
    specs: [
      { label: "Load Capacity", value: "Up to 35kg" },
      { label: "Motion", value: "Soft-close, full extension" },
      { label: "Application", value: "Base Cabinets / Pantry Drawers" },
    ],
    tags: ["Bestseller"],
    featured: true,
    tone: "kitchen",
  },
  {
    ...
    description:
      "A tall pull-out pantry unit with adjustable baskets and synchronized motion, keeping dry storage visible and easy to reach.",
    finishes: ["Graphite", "Stainless Steel"],
    sizes: ["450mm", "600mm"],
    specs: [
      { label: "Basket Levels", value: "5 adjustable levels" },
      { label: "Load Capacity", value: "Up to 80kg" },
      { label: "Motion", value: "Soft-close pull-out" },
    ],
    tags: [],
    tone: "kitchen",
  },
  {
    ...
    description:
      "A two-tier rotating carousel basket for blind corners and L-shaped cabinets, built to bring cookware forward smoothly.",
    finishes: ["Stainless Steel", "Graphite"],
    specs: [
      { label: "Shelves", value: "2 rotating tiers" },
      { label: "Cabinet Fit", value: "900mm corner cabinet" },
      { label: "Motion", value: "Smooth pivot rotation" },
    ],
    tags: ["New"],
    isNew: true,
    tone: "kitchen",
